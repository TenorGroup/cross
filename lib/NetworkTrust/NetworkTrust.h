...
// Mozilla trust anchors, fingerprints and source recorded in roots.json.
namespace network_trust {
inline constexpr char gts[] = R"PEM(-----BEGIN CERTIFICATE-----
...
inline constexpr char isrg1[] = R"PEM(-----BEGIN CERTIFICATE-----
...
inline constexpr char sectigo[] = R"PEM(-----BEGIN CERTIFICATE-----
...
inline constexpr char roots[] = R"PEM(-----BEGIN CERTIFICATE-----
...
inline const char* forUrl(std::string_view url) {
